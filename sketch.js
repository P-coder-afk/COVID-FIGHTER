...
var saveSound,buttonSound,enterSound,pageSound,trainhSound,planetoSound,warningSound,startSound;
var crown;
var BEGIN=0; 
var START=1;
var PLAY=2;
...
startSound=loadSound("mixkit-race-countdown-1953.wav");
//loading background.
...
beggar1.addAnimation("beggar1-1",beggar1Animation1);
beggar1.addAnimation("beggar1-2",beggar1Animation2);
beggar1.scale=0.4;
...
//creating viruses of airport passengers.
av1=createSprite(pa11.x,pa11.y);
av1.addAnimation("av1",redcovidAnimation);
av1.scale=0.09;

av2=createSprite(pa11.x,pa11.y);
av2.addAnimation("av2",orangecovidAnimation);
av2.scale=0.09;

av3=createSprite(pa11.x,pa11.y);
av3.addAnimation("av3",redcovidAnimation);
av3.scale=0.09;

av4=createSprite(pa11.x,pa11.y);
av4.addAnimation("av4",orangecovidAnimation);
av4.scale=0.09;

av5=createSprite(pa11.x,pa11.y);
av5.addAnimation("av5",redcovidAnimation);
av5.scale=0.09;

av6=createSprite(pa11.x,pa11.y);
av6.addAnimation("av6",vAnimation);
av6.scale=0.09;

av7=createSprite(pa11.x,pa11.y);
av7.addAnimation("av7",vAnimation);
av7.scale=0.09;
...
if(reload===10){
  start1.changeAnimation("start1-1",start1Animation);
  start1.visible=true;
  startSound.play();
}

if(reload===25){
  start1.changeAnimation("start1-2",start2Animation);
  start1.visible=true;
}

if(reload===40){
 start1.changeAnimation("start1-3",start3Animation);
 start1.visible=true;
}
...
if(reload===55){
  ...
  start2.visible=true;
  start2.velocityY=-2;
  start2.changeAnimation("start2-1",start4Animation);
...
foodsboard.visible=false;
masksboard.visible=false;
scoresboard.visible=false;
masks.visible=false;
donutfood.visible=false;
life.visible=false;
...
if(keyDown("f")&& (mario.spt.x = beggar1.x)){
      score=score+10;
      food=food-1;
      beggar1.changeAnimation("beggar1-2",beggar1Animation2);
    }  


    //code after touching airport viruses.
    if(mario.spt.isTouching(av2)){
      warningSound.play();
      score=score/4;
      lives=lives-1;
      av2.destroy();
    }
    if(mario.spt.isTouching(av3)){
      warningSound.play();
      score=score/4;
      lives=lives-1;
      av3.destroy();
    }
    if(mario.spt.isTouching(av4)){
      warningSound.play();
      score=score/4;
      lives=lives-1;
      av4.destroy();
    }
    if(mario.spt.isTouching(av5)){
      warningSound.play();
      score=score/4;
      lives=lives-1;
      av5.destroy();
    }
    if(mario.spt.isTouching(av6)){
      warningSound.play();
      score=score/4;
      lives=lives-1;
      av6.destroy();
    }
    if(mario.spt.isTouching(av7)){
      warningSound.play();
      score=score/4;
      lives=lives-1;
      av7.destroy();
    ...
    //code after shooting airport viruses.
    if(shootLeftGroup.isTouching(av1)||(shootRightGroup.isTouching(av1))){
    pointsSound.play();
    av1.destroy();
    score=score+5;
    textFont("Algerian");
  ...
  stroke('white');
    ...
    if(shootLeftGroup.isTouching(av2)||(shootRightGroup.isTouching(av2))){
      pointsSound.play();
      av2.destroy();
      score=score+5;
      textFont("Algerian");
    ...
    if(shootLeftGroup.isTouching(av3)||(shootRightGroup.isTouching(av3))){
      pointsSound.play();
      av3.destroy();
      score=score+5;
      textFont("Algerian");
    ...
    if(shootLeftGroup.isTouching(av4)||(shootRightGroup.isTouching(av4))){
      pointsSound.play();
      av4.destroy();
      score=score+5;
      textFont("Algerian");
    ...
    if(shootLeftGroup.isTouching(av5)||(shootRightGroup.isTouching(av5))){
      pointsSound.play();
      av5.destroy();
      score=score+5;
      textFont("Algerian");
    ...
    if(shootLeftGroup.isTouching(av6)||(shootRightGroup.isTouching(av6))){
      pointsSound.play();
      av6.destroy();
      score=score+5;
      textFont("Algerian");
    ...
    if(shootLeftGroup.isTouching(av7)||(shootRightGroup.isTouching(av7))){
      pointsSound.play();
      av7.destroy();
      score=score+5;
      textFont("Algerian");
...
foodsboard.visible=true;
scoresboard.visible=true;
masksboard.visible=true;
masks.visible=true;
donutfood.visible=true;
life.visible=true;
...
if(gameState==PLAY){
  ...
  function createRightBullet() {
     shoot= createSprite(mario.spt.x+25,mario.spt.y+16);
...
virusGroup.add(virus);
    ...
    if(virusGroup.isTouching(mario.spt)&&(lives===0)){
      gameOverSound.play();
      mario.spt.destroy();
      score=score-5;
      gameState=REPLAY;
